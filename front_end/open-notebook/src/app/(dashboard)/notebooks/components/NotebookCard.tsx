...
export function NotebookCard({ notebook }: NotebookCardProps) {
  ...
  return (
    <>
      <Card
        className="group card-hover flex flex-col min-h-[260px]"
          ...
          <CardHeader className="pb-3">
            <div className="flex items-start justify-between gap-2 min-w-0">
              <div className="flex-1 min-w-0">
                <CardTitle className="text-base group-hover:text-primary transition-colors flex items-center gap-1.5 min-w-0">
                  {notebook.emoji ? <span className="shrink-0">{notebook.emoji}</span> : null}
