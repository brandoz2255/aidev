<script lang="ts">
	...
	let plugins: Plugin[] = [
		...
		{ id: 'opencode', name: 'OpenCode', desc: 'Cloud coding engine', category: 'Development', state: 'configure', scope: 'public', caps: ['edit code', 'run tests', 'multi-file'], lane: 'Lane 3 · sandboxed', auth: 'Per-user key', setup: ['Add your provider key', 'Pick a default model'] },
