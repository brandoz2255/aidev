	...
	>
		...
		<form class="flex-1 min-w-0" on:submit|preventDefault={navigateUrl}>
			<input
				type="text"
				bind:value={urlInput}
				class="w-full text-[11px] font-mono bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg px-3 py-1 outline-none focus:border-blue-400 dark:focus:border-blue-500 focus:ring-1 focus:ring-blue-400/20 text-gray-600 dark:text-gray-300 transition"
