	...
	<div>
		...
		<div class="flex items-center justify-between px-4 pb-3.5 pt-1 gap-2">
			...
			<div class="flex items-center gap-2 shrink-0">
				...
				<button
					class="px-3.5 py-1.5 text-sm bg-black hover:bg-gray-900 text-white dark:bg-white dark:text-black dark:hover:bg-gray-100 transition rounded-lg flex items-center gap-2 {loading
						? 'cursor-not-allowed'
						: ''}"
