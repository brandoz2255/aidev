...
DEFAULT_SOURCES: Dict[str, SourceConfig] = {
    ...
    "ubuntu_security": SourceConfig(
        id="ubuntu_security",
        name="Ubuntu Security Guidelines",
        description="Ubuntu hardening, AppArmor, security updates, best practices for NCAE blue team",
        category=SourceCategory.SECURITY,
        embedding_tier=EmbeddingTier.STANDARD,
        fetcher_type="generic",
        base_url="https://ubuntu.com/security",
        url_patterns=["/security/", "/certification/", "/tutorials/"],
        exclude_patterns=["/blog/", "/blogposts/"],
        rate_limit_delay=0.8,
        max_pages=150,
    ),
    "nginx_hardening": SourceConfig(
        id="nginx_hardening",
        name="Nginx Security Hardening",
        description="Nginx security configuration, TLS, hardening guides, headers, best practices",
        category=SourceCategory.SECURITY,
        embedding_tier=EmbeddingTier.STANDARD,
        fetcher_type="generic",
    ...
    "apache_hardening": SourceConfig(
        ...
        description="Apache HTTP Server security, mod_security, TLS, configuration hardening",
        category=SourceCategory.SECURITY,
        embedding_tier=EmbeddingTier.STANDARD,
        fetcher_type="generic",
    ...
    "owasp_top10": SourceConfig(
        id="owasp_top10",
        name="OWASP Top 10",
        description="OWASP Top 10 Web Application Security Risks - critical vulnerabilities",
        category=SourceCategory.SECURITY,
        embedding_tier=EmbeddingTier.STANDARD,
        fetcher_type="generic",
    ...
    "nist_csf": SourceConfig(
        id="nist_csf",
        name="NIST Cybersecurity Framework",
        description="NIST Cybersecurity Framework guidelines and best practices",
        category=SourceCategory.SECURITY,
        embedding_tier=EmbeddingTier.STANDARD,
        fetcher_type="generic",
        base_url="https://www.nist.gov/cyberframework",
        url_patterns=["/cyberframework/"],
        max_pages=50,
    ),
    "cis_benchmarks": SourceConfig(
        id="cis_benchmarks",
        name="CIS Benchmarks",
        description="Center for Internet Security hardening benchmarks and guides",
        category=SourceCategory.SECURITY,
        embedding_tier=EmbeddingTier.STANDARD,
        fetcher_type="generic",
        base_url="https://www.cisecurity.org/cis-benchmarks",
        url_patterns=["/cis-benchmarks/", "/benchmark/"],
        max_pages=100,
    ),
    "nvd_nist": SourceConfig(
        id="nvd_nist",
        name="National Vulnerability Database",
        description="NIST National Vulnerability Database - CVE information and analysis",
        category=SourceCategory.SECURITY,
        embedding_tier=EmbeddingTier.STANDARD,
        fetcher_type="generic",
        base_url="https://nvd.nist.gov/vuln",
        url_patterns=["/vuln/", "/products/"],
        max_pages=100,
    ),
    "sans_reading_room": SourceConfig(
        ...
        embedding_tier=EmbeddingTier.STANDARD,
        fetcher_type="generic",
        base_url="https://www.sans.org/white-papers",
        url_patterns=["/white-papers/"],
        max_pages=75,
    ),
