"""
MCP Plugin System - Database Models

SQLAlchemy/Pydantic models for plugin data persistence.
"""
...
class OpenClawInstance(BaseModel):
    ...
    user_id: int
    name: str
    vm_type: str = "virtualbox"  # virtualbox, docker, cloud
