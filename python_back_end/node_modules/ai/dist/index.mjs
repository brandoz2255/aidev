...
import { AISDKError as AISDKError13, getErrorMessage as getErrorMessage2 } from "@ai-sdk/provider";
...
var UnsupportedModelVersionError = class extends AISDKError14 {
  constructor(options) {
    super({
...
var _a14;
var UIMessageStreamError = class extends AISDKError15 {
  constructor({
    chunkType,
    chunkId,
    message
...
var _a15;
var InvalidDataContentError = class extends AISDKError16 {
  constructor({
    content,
    cause,
...
var _a16;
var InvalidMessageRoleError = class extends AISDKError17 {
  constructor({
    role,
...
var _a17;
var MessageConversionError = class extends AISDKError18 {
  constructor({
    originalMessage,
    message
  }) {
...
var _a18;
var RetryError = class extends AISDKError19 {
  constructor({
    message,
    reason,
    errors
...
function simulateReadableStream({
  ...
  var _a20;
  const delay2 = (_a20 = _internal == null ? void 0 : _internal.delay) != null ? _a20 : delayFunction;
  let index = 0;
  return new ReadableStream({
    async pull(controller) {
...
var NoSuchProviderError = class extends NoSuchModelError3 {
  ...
  static isInstance(error) {
    return AISDKError23.hasMarker(error, marker19);
  }
};
_a19 = symbol19;
