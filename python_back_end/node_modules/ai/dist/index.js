...
__export(src_exports, {
  ...
  LoadSettingError: () => import_provider20.LoadSettingError,
  ...
  TooManyEmbeddingValuesForCallError: () => import_provider20.TooManyEmbeddingValuesForCallError,
...
var UnsupportedModelVersionError = class extends import_provider14.AISDKError {
  constructor(options) {
    super({
...
var _a14;
var UIMessageStreamError = class extends import_provider15.AISDKError {
  constructor({
    chunkType,
    chunkId,
    message
...
var _a15;
var InvalidDataContentError = class extends import_provider16.AISDKError {
  constructor({
    content,
    cause,
...
var _a16;
var InvalidMessageRoleError = class extends import_provider17.AISDKError {
  constructor({
    role,
...
var _a17;
var MessageConversionError = class extends import_provider18.AISDKError {
  constructor({
    originalMessage,
    message
  }) {
...
var _a18;
var RetryError = class extends import_provider19.AISDKError {
  constructor({
    message,
    reason,
    errors
...
function resolveTranscriptionModel(model) {
  ...
  return (_b = (_a20 = getGlobalProvider()).transcriptionModel) == null ? void 0 : _b.call(_a20, model);
}
function resolveSpeechModel(model) {
  ...
  return (_b = (_a20 = getGlobalProvider()).speechModel) == null ? void 0 : _b.call(_a20, model);
}
...
function getGlobalProvider() {
  var _a20;
  return (_a20 = globalThis.AI_SDK_DEFAULT_PROVIDER) != null ? _a20 : import_gateway.gateway;
}
...
// src/version.ts
var VERSION = true ? "6.0.59" : "0.0.0-test";
...
async function standardizePrompt(prompt) {
  if (prompt.prompt == null && prompt.messages == null) {
    throw new import_provider23.InvalidPromptError({
      prompt,
...
function wrapGatewayError(error) {
  ...
  if (isProductionEnv) {
    return new import_provider24.AISDKError({
      name: "GatewayError",
...
async function _retryWithExponentialBackoff(f, {
  ...
  try {
    ...
    if (error instanceof Error && import_provider25.APICallError.isInstance(error) && error.isRetryable === true && tryNumber <= maxRetries) {
  ...
  return {
    ...
    async parseCompleteOutput({ text: text2 }, context2) {
      ...
      if (outerValue == null || typeof outerValue !== "object" || !("elements" in outerValue) || !Array.isArray(outerValue.elements)) {
        throw new NoObjectGeneratedError({
          message: "No object generated: response did not match schema.",
          cause: new import_provider26.TypeValidationError({
            value: outerValue,
...
function hasToolCall(toolName) {
  return ({ steps }) => {
    var _a20, _b, _c;
    return (_c = (_b = (_a20 = steps[steps.length - 1]) == null ? void 0 : _a20.toolCalls) == null ? void 0 : _b.some(
...
var DefaultStreamTextResult = class {
      ...
      async pull(controller) {
        function abort() {
          ...
          controller.enqueue({
            ...
            ...(abortSignal == null ? void 0 : abortSignal.reason) !== void 0 ? { reason: (0, import_provider27.getErrorMessage)(abortSignal.reason) } : {}
          });
          controller.close();
        }
        try {
  ...
  toUIMessageStream({
    ...
    sendStart = true,
    sendFinish = true,
    onError = import_provider27.getErrorMessage
  } = {}) {
...
var ToolLoopAgent = class {
  ...
  async prepareCall(options) {
    ...
    const baseCallArgs = {
      ...
      stopWhen: (_a20 = this.settings.stopWhen) != null ? _a20 : stepCountIs(20),
      ...options
    };
...
function readUIMessageStream({
  ...
  const state = createStreamingUIMessageState({
    messageId: (_a20 = message == null ? void 0 : message.id) != null ? _a20 : "",
    lastMessage: message
  });
        ...
        modelMessages.push({
          ...
          content: message.parts.map((part) => {
            ...
            if (isDataUIPart(part)) {
              return (_a20 = options == null ? void 0 : options.convertDataPart) == null ? void 0 : _a20.call(
                options,
                part
              );
            }
        ...
        () => (
          ...
          recordSpan({
            ...
            fn: async (doEmbedSpan) => {
              ...
              const usage2 = (_a20 = modelResponse.usage) != null ? _a20 : { tokens: NaN };
            ...
            return retry(() => {
              return recordSpan({
                ...
                fn: async (doEmbedSpan) => {
                  ...
                  const usage = (_a21 = modelResponse.usage) != null ? _a21 : { tokens: NaN };
                  doEmbedSpan.setAttributes(
                    await selectTelemetryAttributes({
                      telemetry,
                      attributes: {
            ...
            if (!providerMetadata) {
              ...
              for (const [providerName, metadata] of Object.entries(
                ...
                providerMetadata[providerName] = {
                  ...(_a20 = providerMetadata[providerName]) != null ? _a20 : {},
                  ...metadata
                };
              }
            }
...
async function generateImage({
  ...
  const maxImagesPerCallWithDefault = (_a20 = maxImagesPerCall != null ? maxImagesPerCall : await invokeModelMaxImagesPerCall(model)) != null ? _a20 : 1;
...
var arrayOutputStrategy = (schema) => {
  return {
    ...
    async validatePartialResult({
      ...
      var _a20;
      if (!(0, import_provider29.isJSONObject)(value) || !(0, import_provider29.isJSONArray)(value.elements)) {
        return {
          success: false,
      ...
      const publishedElementCount = (_a20 = latestObject == null ? void 0 : latestObject.length) != null ? _a20 : 0;
      let textDelta = "";
      if (isFirstDelta) {
        textDelta += "[";
      }
...
var enumOutputStrategy = (enumValues) => {
  return {
    ...
    async validateFinalResult(value) {
      if (!(0, import_provider29.isJSONObject)(value) || typeof value.result !== "string") {
        return {
          success: false,
          error: new import_provider29.TypeValidationError({
            value,
...
async function parseAndValidateObjectResultWithRepair(result, outputStrategy, repairText, context2) {
  try {
    ...
    if (repairText != null && NoObjectGeneratedError.isInstance(error) && (import_provider30.JSONParseError.isInstance(error.cause) || import_provider30.TypeValidationError.isInstance(error.cause))) {
  ...
  try {
    return await recordSpan({
      ...
      fn: async (span) => {
        ...
        const generateResult = await retry(
          () => recordSpan({
            ...
            fn: async (span2) => {
              ...
              const responseData = {
                id: (_b = (_a21 = result2.response) == null ? void 0 : _a21.id) != null ? _b : generateId2(),
        ...
        request = (_a20 = generateResult.request) != null ? _a20 : {};
...
var DefaultGenerateObjectResult = class {
  ...
  toJsonResponse(init) {
    ...
    return new Response(JSON.stringify(this.object), {
      status: (_a20 = init == null ? void 0 : init.status) != null ? _a20 : 200,
...
function simulateReadableStream({
  ...
  var _a20;
  const delay2 = (_a20 = _internal == null ? void 0 : _internal.delay) != null ? _a20 : import_provider_utils29.delay;
  let index = 0;
  return new ReadableStream({
    async pull(controller) {
          ...
          new TransformStream({
            async transform(chunk, controller) {
              ...
              switch (chunk.type) {
                case "response-metadata": {
                  fullResponse = {
                    id: (_a20 = chunk.id) != null ? _a20 : fullResponse.id,
...
async function generateSpeech({
  ...
  return new DefaultSpeechResult({
    audio: new DefaultGeneratedAudioFile({
      data: result.audio,
      mediaType: (_a20 = detectMediaType({
        data: result.audio,
...
var DefaultSpeechResult = class {
  constructor(options) {
    ...
    this.warnings = options.warnings;
    this.responses = options.responses;
    this.providerMetadata = (_a20 = options.providerMetadata) != null ? _a20 : {};
  }
};
...
function smoothStream({
  ...
  if (chunking != null && typeof chunking === "object" && "segment" in chunking && typeof chunking.segment === "function") {
    ...
    if (chunkingRegex == null) {
      throw new import_provider31.InvalidArgumentError({
        argument: "chunking",
...
function extractJsonMiddleware(options) {
  var _a20;
  const transform = (_a20 = options == null ? void 0 : options.transform) != null ? _a20 : defaultTransform;
...
function addToolInputExamplesMiddleware({
  ...
  return {
    ...
    transformParams: async ({ params }) => {
      var _a20;
      if (!((_a20 = params.tools) == null ? void 0 : _a20.length)) {
        return params;
      }
      const transformedTools = params.tools.map((tool2) => {
        var _a21;
        if (tool2.type !== "function" || !((_a21 = tool2.inputExamples) == null ? void 0 : _a21.length)) {
          return tool2;
        }
...
var doWrap3 = ({
  ...
  const maxImagesPerCallRaw = (_a20 = overrideMaxImagesPerCall == null ? void 0 : overrideMaxImagesPerCall({ model })) != null ? _a20 : model.maxImagesPerCall;
...
function customProvider({
  ...
  return {
    ...
    languageModel(modelId) {
      ...
      throw new import_provider32.NoSuchModelError({ modelId, modelType: "languageModel" });
    },
    embeddingModel(modelId) {
      ...
      throw new import_provider32.NoSuchModelError({ modelId, modelType: "embeddingModel" });
    },
    imageModel(modelId) {
    ...
    rerankingModel(modelId) {
      ...
      throw new import_provider32.NoSuchModelError({ modelId, modelType: "rerankingModel" });
    }
  };
}
...
var _a19;
var NoSuchProviderError = class extends import_provider33.NoSuchModelError {
  constructor({
    modelId,
    modelType,
    providerId,
    ...
    super({ errorName: name19, modelId, modelType, message });
    this[_a19] = true;
    this.providerId = providerId;
    this.availableProviders = availableProviders;
  }
  static isInstance(error) {
    return import_provider33.AISDKError.hasMarker(error, marker19);
  }
};
_a19 = symbol19;
...
var DefaultProviderRegistry = class {
  ...
  splitId(id, modelType) {
    ...
    if (index === -1) {
      throw new import_provider34.NoSuchModelError({
        modelId: id,
        modelType,
  ...
  languageModel(id) {
    ...
    let model = (_b = (_a20 = this.getProvider(providerId, "languageModel")).languageModel) == null ? void 0 : _b.call(
      _a20,
      modelId
    );
    if (model == null) {
      throw new import_provider34.NoSuchModelError({ modelId: id, modelType: "languageModel" });
    }
  ...
  embeddingModel(id) {
    ...
    const model = (_a20 = provider.embeddingModel) == null ? void 0 : _a20.call(provider, modelId);
    if (model == null) {
      throw new import_provider34.NoSuchModelError({
        modelId: id,
  ...
  imageModel(id) {
    ...
    let model = (_a20 = provider.imageModel) == null ? void 0 : _a20.call(provider, modelId);
    if (model == null) {
      throw new import_provider34.NoSuchModelError({ modelId: id, modelType: "imageModel" });
    }
  ...
  transcriptionModel(id) {
    ...
    const model = (_a20 = provider.transcriptionModel) == null ? void 0 : _a20.call(provider, modelId);
    if (model == null) {
      throw new import_provider34.NoSuchModelError({
        modelId: id,
  ...
  speechModel(id) {
    ...
    const model = (_a20 = provider.speechModel) == null ? void 0 : _a20.call(provider, modelId);
    if (model == null) {
      throw new import_provider34.NoSuchModelError({ modelId: id, modelType: "speechModel" });
    }
    return model;
  }
  rerankingModel(id) {
    ...
    const model = (_a20 = provider.rerankingModel) == null ? void 0 : _a20.call(provider, modelId);
    if (model == null) {
      throw new import_provider34.NoSuchModelError({ modelId: id, modelType: "rerankingModel" });
    }
    return model;
  }
};
    ...
    fn: async () => {
      ...
      return new DefaultRerankResult({
        ...
        response: {
          ...
          timestamp: (_a20 = response == null ? void 0 : response.timestamp) != null ? _a20 : /* @__PURE__ */ new Date(),
...
async function callCompletionApi({
  ...
  try {
    ...
    if (!response.ok) {
      throw new Error(
        (_a20 = await response.text()) != null ? _a20 : "Failed to fetch the chat response."
      );
    }
    if (!response.body) {
...
async function convertFileListToFileUIParts(files) {
  ...
  return Promise.all(
    Array.from(files).map(async (file) => {
      const { name: name20, type } = file;
      const dataUrl = await new Promise((resolve3, reject) => {
        const reader = new FileReader();
        reader.onload = (readerEvent) => {
          var _a20;
          resolve3((_a20 = readerEvent.target) == null ? void 0 : _a20.result);
        };
...
var HttpChatTransport = class {
  ...
  async sendMessages({
    ...
    const preparedRequest = await ((_a20 = this.prepareSendMessagesRequest) == null ? void 0 : _a20.call(this, {
      api: this.api,
      id: options.chatId,
  ...
  async reconnectToStream(options) {
    ...
    const preparedRequest = await ((_a20 = this.prepareReconnectToStreamRequest) == null ? void 0 : _a20.call(this, {
      api: this.api,
      id: options.chatId,
      body: { ...resolvedBody, ...options.body },
      headers: baseHeaders,
  ...
  constructor({
    ...
    this.stop = async () => {
      ...
      if (this.status !== "streaming" && this.status !== "submitted")
        return;
      if ((_a20 = this.activeResponse) == null ? void 0 : _a20.abortController) {
    ...
    try {
        ...
        this.jobExecutor.run(
          () => job({
            ...
            write: () => {
              ...
              const replaceLastMessage = activeResponse.state.message.id === ((_a21 = this.lastMessage) == null ? void 0 : _a21.id);
      ...
      try {
        (_b = this.onFinish) == null ? void 0 : _b.call(this, {
          ...
          isDisconnect,
          isError,
          finishReason: (_a20 = this.activeResponse) == null ? void 0 : _a20.state.finishReason
        });
      } catch (err) {
        console.error(err);
      }
